        ...
        <Box {...row}>
          <Box {...col} {...textArea}>
            <Fade bottom cascade>
              <Heading
                {...title}
                content="Work with Hug A Pet and increase your revenue!"
              />
              <Text
                {...description}
                content="Being a vet is a challenging job, and we understand that! Hug a pet offers a range of digital tools and services to manage you bookings and schedule. Do what you love hassle free!"
              />
              <Box>
                <Link href="#">
                  <a>
